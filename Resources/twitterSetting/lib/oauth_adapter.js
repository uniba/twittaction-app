 ...
 */
Ti.include('../../../../../../../../../twitterSetting/lib/sha1.js');
Ti.include('../../../../../../../../../twitterSetting/lib/oauth.js');
...
var OAuthAdapter = function(pConsumerSecret, pConsumerKey, pSignatureMethod)
 {
    ...
    this.saveAccessToken = function(pService)
    {
        ...
        Ti.API.info('accessTokenSecret: '+accessTokenSecret);
        Ti.API.info('screen_name : '+screen_name);
        Ti.API.info('user_id : '+user_id);
    };
...
/*_追加_____________________________________________*/
    var sendTweet = function(pUrl, pParameters, pTitle, pSuccessMessage, pErrorMessage)
    {
        Ti.API.debug('Sending a message to the service at [' + pUrl + '] with the following params: ' + JSON.stringify(pParameters));
...
/*_追加 終_____________________________________________*/
};